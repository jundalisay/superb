...
Gli'dn-Mang comes from different places. 
...
is,
tree;
as a rule, considered superior in quality if
and
inferior, if
it
comes 25
from a decayed one. The hard and black
...
iW
;
one looks like a rhinoceros horn
and
(si-kio),
is
called ti-kio-ch^on
"rhinoceros horn gharu-wood»); another which resembles the beak 30
of a swallow (yen-k'ou),
is
called
...
The natives
^)
pure and strong and apt to evaporate; in burning
...
it is
of China, even the leaves are like
^).
('IJ?
...
Ting-liiang
They are
come from the countries of the Ta-shi and from Sho-p'o.
called ting-liiang or «nail-incense» because they resemble in shape
the Chinese character ting (Hp, «a
nail»).
bad smells from the mouth, and high
so mouths
when they have
date
...
-^), and
say that
Emperor. The large ones
this is the
M-sM-Mang
of removing
Court put cloves into their
to lay matters before the
are called ting-hiang-mu (~J^
(^
(T #).
is
same as ki-sho-Mang
the stone of the Persian
Note.
•35
In the
first

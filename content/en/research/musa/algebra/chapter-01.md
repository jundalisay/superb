...
five
half
equal to eighteen ;"{ then the square
its
root
is
is six.
...
and roots equal
squares
to roots;" "roots and numbers equal to squares."
thus three
equal
...
= 
you
halve the number= )=  of the roots, which in the present
instance yields
the product
the
is
...
the roots and simple numbers which are connected
single square,
also
in the
therewith.
For
" two
squares and ten roots are equal
instance,
...
and
in the statement to its half,
if
the question
every
it
will
had been, a square and
...
the pro-
itself;
and a quarter. Add this to twenty-four; the
Take the root of
thirty dirhems and a quarter.
and a
number of
1
ex'
...
effect
it.
roots, is equal to twenty-eight dir-
it
amounts
is
added to
...
and Numbers are equal to Roots;* for
" a
instance,
square and twenty-one in numbers are
Squares
That

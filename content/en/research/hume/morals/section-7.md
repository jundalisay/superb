...
<!-- Whoever has passed an evening with serious melancholy people, and has observed how  was animated, and what sprightliness diffused itself over the countenance, discourse, and behaviour of every one, on the accession of a good-humoured,  companion; such a one will easily allow that

 , and naturally conciliates the good-will of mankind. 

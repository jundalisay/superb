...
<ul>
  <li>He must toil at learning and at gymnastics, or else he will never reach the highest knowledge of all.</li>
</ul>
...
<ul>
  <li>They reproach us with our ignorance of the good.</li>
  <li>They define the good as the knowledge of the good, which is ridiculous.</li>
</ul>

Those who make pleasure their good are in equal perplexity.
<ul>
  <li>They admit that there are bad pleasures as well as good.</li>
  <li>This makes them acknowledge that bad and good are the same.</li>
</ul>
...
We have a presentiment that there is such an end. Yet we hesitate because:
<ul>
  <li>we do not know the nature of the good, and</li>
  <li>we do not have the same assurance of the good as of other things.</li>
</ul>
...
{{< l a="Socrates" >}}
<!-- For now, let us not ask what is the actual nature of the good because answering it would be an effort too great for me.

But we can explain the child of the good who is likest him.
There is an old story, that there are many beautiful and good things. -->

There is an absolute beauty and an absolute good. This absolute is the essence of each.
<ul>
  <li>The many are seen but not known.</li>
  <li>The ideas are known but not seen.</li>
</ul>
...
That light which makes the eye see belongs to the sun, but the <!-- 
The relation of sight to this deity is that  -->neither sight nor the eye resides in the sun. Yet of all the sensory organs, the eye is the most like the sun. The power of the eye <!-- is a sort of effluence which --> comes from the sun.
...
<!--  child of the good came

The same is true for the child of the good, whom the good begat in his own likeness to be in the visible world. The good in the intellectual world objects of the mind -->
 
The eyes are nearly blind when they use the light from the moon and stars only. But they see clearly under the sun.
<!-- They have no clearness of vision in them -->
...
<!-- Yes, but there is more to be said about the sun. -->
{{< l a="Socrates" >}}
There are two ruling powers.

<ul>
  <li>One of them is set over the 'intellectual world' instead of 'heaven'</li>
  <li>The other over is over the visible</li>
</ul>

Create these two worlds in your mind.
<ul>
  <li>Take a line which has been cut into two unequal parts.</li>
  <li>Divide each of them again in the same proportion.</li>
</ul>
...
<ul>
  <li>In the lower, the soul uses the figures given by the higher division as images. Enquiries here can only be hypothetical. It descends to the lower end*, instead of going upwards to a higher principle.</li>
  <li>In the higher, the soul passes out of hypotheses and goes up to a principle which is above hypotheses. It uses no images unlike in the former case. Instead, it proceeds through the ideas themselves.</li>
</ul>

> *Translator's note= An example of the lower subdivision is solving a math problem. An example of the higher subdivision is looking at the nature or root causes of phenomena.
...
<ul>
  <li>Yet, they start from hypotheses and do not ascend to a principle.</li>
  <li>This is why those who contemplate them appear to you not to exercise the higher reason on them, although when a first principle is added to them, they are cognizable by the higher reason.</li>
  <li>You call geometry and the cognate sciences as "understanding" and not "reason", as being between opinion and reason.
{{< /r >}}
...
<ol>
  <li>reason answers to the highest faculty</li>
  <li>understanding answers to the second</li>
  <li>faith (or conviction) answers to the third, and</li>
  <li>perception of shadows to the last</li>
</ol>

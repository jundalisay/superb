...
- This is becuase it has no method of analysis to tackle the problem*.
...
The transfer from wage-earners to other factors will diminish the propensity to consume. 
...
2. If we are dealing with an unclosed system, and the reduction of money-wages is a reduction relatively to money-wages abroad when both are reduced to a common unit, then the change will be favourable to investment, since it will tend to increase the balance of trade. 

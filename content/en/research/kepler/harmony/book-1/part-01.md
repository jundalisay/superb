...
## 4. Proposition: All regular shapes can be placed so that all their angles simultaneously lie on the same circle
...
But in fact it is necessary that, if one is inscribed, it should be possible to inscribe them all. For all the sides are equal; therefore the segments of the circle cut off by the two sides around one angle are equal, by Euclid III.24. 

Therefore, as the angle fits, so do the extremities of the sides fit in the same circle. Indeed the extremities of the sides are the angles.^ It would be otherwise, if, although the angles were equal the sides were not equal, for then the necessity that it should be possible to inscribe them all would disappear.

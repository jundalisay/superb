...
It follows that happiness is the criterion of morality<!-- , since a part is included in the whole -->.

<!-- nothing which is not either a part of happiness or a means of happiness, we can have no other proof, and we require no other, that these are the only things desirable. If so,  -->
...
This is so obvious. The <!--  that I expect it will hardly be disputed= and the --> objection made will be, not that desire can possibly be directed to anything ultimately except pleasure and exemption from pain, but that the will is a different thing from desire.
...
<!-- All this I fully admit, and have stated it elsewhere, as positively and emphatically as any one. --> Will is the active phenomenon. It is a different thing from desire which is the state of passive sensibility. 

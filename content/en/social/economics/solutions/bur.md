...
<!-- The proper solution is to break apart the dual function of money and reduce it to two separate systems: 
- one for the store of value
- another for the tool of trade 

The points system becomes the store of value, while the apps become the tools of trade. Unlike currency or crypto, **the points are not tradeable to everyone**. This means that they are not legal tender.   

Instead of exchange, the general actions are either deposit or withdraw. This makes the system more like a rationing system instead of a trading one.  -->
...
> **David Hume mentioned that common interest is more fundamental than the social contracts that lead to laws and governments. This common interest is seen in the symbiosis of animals and in the ties that bind human families. Animals and families do not need written laws to be held together, but governments and countries do. This makes animal and family societies maintainable at lower cost than governments.

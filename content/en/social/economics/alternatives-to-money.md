...
- [Clearing Funds as an alternative to Bonds](/solutions/pantrynomics/multilateral-pool-clearing)
- [Purchasing Power as an alterative to GDP](/articles/pantrynomics/the-alternative-to-gdp) 
- Basic Universal Revenue as an alternative to money
- [The Effort Theory of Value](/articles/pantrynomics/the-effort-theory-of-value) as an alternative to Marginal Pricing

The next post will explain how Grain-based Valuation can be implemented as Basic Universal Revenue. This will be very useful during [the coming Great Stagflation](/social/precrisis-years) which is supposed to spark this year.
